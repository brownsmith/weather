...
Forecast.weatherToday = function() {
	...
	if (weatherDataObj.data.error) {

		// display whoops message
		displayWeatherDiv.innerHTML = '<h4>Whoops</h4>'
									+ '<p>' + weatherDataObj.data.error[0].msg + '</p>';

		// get BODY element
		var bodyElem = document.getElementsByTagName('body')[0];

		// add error class to BODY
		Forecast.addClass(bodyElem, 'error');
	...
	if (localStorage.getItem('tempType') === 'F') {
		...
		displayWeatherDiv.innerHTML = 
			...
			// location goes here
			'<h1 class=\"forecast_location\"><span></span>' + weatherDataObj.data.request[0].query + '</h1>' + temp + '<h2>' + weatherNum + '</h2>'

			// list for next five days weather summary
			+ '<ul class=\"next5 clearfix\">'

			// day 2
			+ '<li>' 

				+ '<p class=\"day style_' + weatherDataObj.data.weather[1].weatherCode + '\">' + Forecast.formatDate(weatherDataObj.data.weather[1].date) + '<span></span></p>'  

				+ '<p>MIN ' + weatherDataObj.data.weather[1].tempMinF + '&#176;F</p>' 

				+ '<p>MAX ' + weatherDataObj.data.weather[1].tempMaxF + '&#176;F</p>'
			...
			+ '<li>' 
				...
				+ '<p class=\"day style_' + weatherDataObj.data.weather[2].weatherCode + '\">' + Forecast.formatDate(weatherDataObj.data.weather[2].date) + '<span></span></p>'  

				+ '<p>MIN ' + weatherDataObj.data.weather[2].tempMinF + '&#176;F</p>' 

				+ '<p>MAX ' + weatherDataObj.data.weather[2].tempMaxF + '&#176;F</p>'
			...
			+ '<li>' 
				...
				+ '<p class=\"day style_' + weatherDataObj.data.weather[3].weatherCode + '\">' + Forecast.formatDate(weatherDataObj.data.weather[3].date) + '<span></span></p>'  

				+ '<p>MIN ' + weatherDataObj.data.weather[3].tempMinF + '&#176;F</p>' 

				+ '<p>MAX ' + weatherDataObj.data.weather[3].tempMaxF + '&#176;F</p>'
			...
			+ '<li>' 
				...
				+ '<p class=\"day style_' + weatherDataObj.data.weather[4].weatherCode + '\">' + Forecast.formatDate(weatherDataObj.data.weather[4].date) + '<span></span></p>'  

				+ '<p>MIN ' + weatherDataObj.data.weather[4].tempMinF + '&#176;F</p>' 

				+ '<p>MAX ' + weatherDataObj.data.weather[4].tempMaxF + '&#176;F</p>'
	...
	if (localStorage.getItem('tempType') === 'C') {
		...
		displayWeatherDiv.innerHTML = 
			...
			+ '<li>' 
				...
				+ '<p>Min ' + weatherDataObj.data.weather[1].tempMinC + '&#176;C</p>' 

				+ '<p>Max ' + weatherDataObj.data.weather[1].tempMaxC + '&#176;C</p>'
			...
			+ '<li>' 
				...
				+ '<p>Min ' + weatherDataObj.data.weather[2].tempMinC + '&#176;C</p>' 

				+ '<p>Max ' + weatherDataObj.data.weather[2].tempMaxC + '&#176;C</p>'
			...
			+ '<li>' 
				...
				+ '<p>Min ' + weatherDataObj.data.weather[3].tempMinC + '&#176;C</p>' 

				+ '<p>Max ' + weatherDataObj.data.weather[3].tempMaxC + '&#176;C</p>'
			...
			+ '<li>' 
				...
				+ '<p>Min ' + weatherDataObj.data.weather[4].tempMinC + '&#176;C</p>' 

				+ '<p>Max ' + weatherDataObj.data.weather[4].tempMaxC + '&#176;C</p>'
...
Forecast.formatDate = function(dateData) {
	...
	// Sunday
	if (getday===0) {getday = 'Sun'} 

	// Monday
	if (getday===1) {getday = 'Mon'} 

	// Tuesday
	if (getday===2) {getday = 'Tue'}

	// Wednesday
	if (getday===3) {getday = 'Wed'} 

	// Thursday
	if (getday===4) {getday = 'Thu'} 

	// Friday
	if (getday===5) {getday = 'Fri'} 

	// Saturday
	if (getday===6) {getday = 'Sat'} 
...
Forecast.setBodyClass = function(condition) {
	...
	Forecast.addClass(bodyElem, bodyClass);
